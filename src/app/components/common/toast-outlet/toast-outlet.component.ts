...
import { ToastMessage, ToastService } from '../../../services/app/toast/toast.service';
...
@Component({
    ...
    host: {
        class: 'fixed z-[10000] top-0 bottom-0 left-0 right-0 pointer-events-none p-4 flex flex-col items-center justify-end',
    }
})
